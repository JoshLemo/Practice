 ...
 * <p>
 * The Locale used is: language = English, country = US. This is consistent with the formatting
 * conventions with Java floating-point literals, command-line arguments (via
 * {@link Double#parseDouble(String)}) and standard output.
 * <p>
 * For additional documentation, see <a href="http://introcs.cs.princeton.edu/31datatype">Section
 * 3.1</a> of <i>Introduction to Programming in Java: An Interdisciplinary Approach</i> by Robert
 * Sedgewick and Kevin Wayne.
 * <p>
 * Like {@link Scanner}, reading a token also consumes preceding Java whitespace, reading a full
 ...
 * <a href="http://www.docjar.com/html/api/java/util/Scanner.java.html"> Scanner.java</a> (NB: Java
 * 6u23 and earlier uses only \r, \r, \r\n).
 *
...
public final class In {
   ...
   * call to {@link #readLine()} will succeed. This method is functionally equivalent to
   * {@link #hasNextChar()}.
   *
  ...
  /**
   * Returns true if this input stream has more inputy (including whitespace). Use this method to
  ...
  /**
   * Reads the next token from this input stream, parses it as a {@code int}, and returns the
   * {@code int}.
   *
